 ...
 * Data Display Plugin
 *
 * Components for displaying data: BigValue, DataTable, Value
 */
...
export { bigValueRegistration, dataTableRegistration, valueRegistration }
...
export function registerDataDisplayPlugins(registry: ComponentRegistry): void {
  ...
  console.log('✅ Data display plugins registered: bigvalue, datatable, value')
}
