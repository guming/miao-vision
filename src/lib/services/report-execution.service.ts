...
import { parseMarkdown, extractSQLBlocks } from '@/lib/markdown/parser'
import { executeReport as executeReportSQL } from '@/lib/markdown/sql-executor'
import {
  processConditionals,
  buildConditionalContext,
  hasConditionalBlocks
} from '@/lib/markdown/conditional-processor'
import { initializeInputDefaults } from '@/lib/inputs/initialize-defaults'
import {
  findAffectedBlocks,
  reExecuteAffectedBlocks,
  getChangedInputs
} from '@/lib/execution/reactive-executor'
import { buildChartFromBlock } from '@/lib/markdown/chart-builder'
import { coordinator, duckDBManager } from '@/lib/database'
import type { DependencyAnalysis } from '@/lib/core/dependency-graph'
